...
function Services() {
  ...
  const services = [
    ...
    },
    {
      ...
      features: ["Técnicas de relaxamento", "Reestruturação cognitiva", "Manejo de crises"]
    },
    {
      icon: (
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    },
    {
      ...
      description: "Apoio para decisões profissionais, transições de carreira e desenvolvimento de competências emocionais no trabalho.",
      features: ["Autoconhecimento profissional", "Planejamento", "Equilíbrio vida-trabalho"]
    }
  ]
